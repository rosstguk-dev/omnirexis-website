...
**Last updated:** 18 September 2026, 18:18 BST
...
| Drive folder OMNIREXIS file `OMNIREXIS-MASTER.md` (`1AfE2OnLWmzz0Z4wngPnfAdflvMgaYksb`) | Mirror for phone / Drive-connected bots. |
...
Write like Ross messaging another operator, not like a sales sequence:
